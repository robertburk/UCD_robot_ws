...
(cl:in-package gripper_position_controller-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <TargetDelta>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TargetDelta)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gripper_position_controller-msg:<TargetDelta> is deprecated: use gripper_position_controller-msg:TargetDelta instead.")))

(cl:ensure-generic-function 'target_delta-val :lambda-list '(m))
(cl:defmethod target_delta-val ((m <TargetDelta>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gripper_position_controller-msg:target_delta-val is deprecated.  Use gripper_position_controller-msg:target_delta instead.")
  (target_delta m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<TargetDelta>)))
  ...
  "gripper_position_controller/TargetDelta")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'TargetDelta)))
  "Returns string type for a message object of type 'TargetDelta"
  "gripper_position_controller/TargetDelta")
