...
(cl:defmethod cl:initialize-instance :after ((m <TargetForce>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TargetForce)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gripper-msg:<TargetForce> is deprecated: use gripper-msg:TargetForce instead.")))

(cl:ensure-generic-function 'target_force-val :lambda-list '(m))
(cl:defmethod target_force-val ((m <TargetForce>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gripper-msg:target_force-val is deprecated.  Use gripper-msg:target_force instead.")
  (target_force m))
