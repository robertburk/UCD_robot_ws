...
(cl:in-package grip_force_protocol-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <TargetForce>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TargetForce)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name grip_force_protocol-msg:<TargetForce> is deprecated: use grip_force_protocol-msg:TargetForce instead.")))

(cl:ensure-generic-function 'target_force-val :lambda-list '(m))
(cl:defmethod target_force-val ((m <TargetForce>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader grip_force_protocol-msg:target_force-val is deprecated.  Use grip_force_protocol-msg:target_force instead.")
  (target_force m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<TargetForce>)))
  ...
  "grip_force_protocol/TargetForce")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'TargetForce)))
  "Returns string type for a message object of type 'TargetForce"
  "grip_force_protocol/TargetForce")
